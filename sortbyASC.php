...
$sql="SELECT StudentID, NIC, FacultyName, BatchName,Stu_firstName,Stu_lastName,Gender,DOB,PhoneNum,PermanentAddress FROM student, batch, faculty WHERE batch.BatchID=student.BatchID && faculty.FacultyID=student.FacultyID ORDER BY Stu_firstName ASC";
